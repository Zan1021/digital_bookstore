"""
Test V8 rendering engine.
Reads translations from the database and runs V8 engine.
"""
import json
import os
import sqlite3
...
output_pdf = os.path.join(base_dir, "storage", "app", "public", "books", "translated", "2_af_v8.pdf")
